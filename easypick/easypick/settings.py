"""
Django settings for easypick project.
...
SECRET_KEY = 'temporary-secret-key-for-debugging'
...
MIDDLEWARE = [
    ...
    # Allauth (only once, at correct place)
    'allauth.account.middleware.AccountMiddleware',
]

ROOT_URLCONF = 'easypick.urls'
...
WSGI_APPLICATION = 'easypick.wsgi.application'
